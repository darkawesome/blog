...
date: 2025-12-30T16:00:58-05:00
url: /TailscaleDns/
...
- [x] wanting to use more docker environments and use cases
- [ ] wanting to use kubernetes for things as well
- [x] Using subnets for different locations to extend the tailscale network where things are physically located
- [ ] When setting up a high availability cluster what are all the things that I need to worry about from load balancing to when a vm goes done etc. Edit 2026-June 29 : this is a longterm step that will happen farther down the line when I need more compute. Which is most likely going to be soon though prices are not too friendly.
