...
- **Why didn't they run scripts and automate the attacks? 
		- the exploits used were run-of-the-mill so wouldn't defenses against this would be available already?
